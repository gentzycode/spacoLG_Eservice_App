                                ...
                                <div className='my-4 space-y-4'>
...

                                    {
                                        showinfo && <div className='w-full border border-gray-100 rounded-md bg-gray-50 p-4 text-gray-600'>
                                            <h1 className='flex justify-between items-center uppercase font-bold mb-2 pb-4 border-b border-gray-200'>
                                                <span>Application request preview</span>
                                                <span className='cursor-pointer text-red-600' onClick={() => toggleInfo()}>
