...
const Reviews = ({ id, flag }) => {
    ...
    return (
        <div className='flex justify-center my-4'>
            {
                user?.role === 'PublicUser' && <div className='w-full flex justify-between items-center rounded-lg bg-orange-100 text-orange-700 p-4'>
                        ...
                        <div className='col-span-1 py-3 md:pr-3 md:border-r border-gray-200'>
                            {
                                approving ? 
                                    ...
                                    >
                                        {
                                            flag === 'AWAITING_PAYMENT_CONFIRMATION' ? 'Confirmed' : 'Reviewed'
                                        }
                                    </button>
                            }
                        </div>
