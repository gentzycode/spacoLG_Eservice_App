...
const Sidebar = ({ toggleSidebar, navOpen }) => {
    return (
        <Fragment>
            ...
            ></div>
            <div className={`absolute left-0 top-0 z-50 ${navOpen ? 'block w-[230px]' : 'hidden'} md:block md:w-[230px] h-screen bg-[#02380c] overflow-y-hidden duration-300 ease-linear`}>
